...
class SearchbyCost extends StatefulWidget {
  String drop;
  String User;
  int uid;
  SearchbyCost(
  ...
  @override
  _SearchbyCostState createState() => _SearchbyCostState();
}

class _SearchbyCostState extends State<SearchbyCost> {
  Future<List<Search>> searchOld() async {
    final response = await http.get(Uri.parse(
        'http://${IpAdress.ip}/OldHome1/api/oldhome/searchbycost?city=${widget.drop}'));
